...
namespace VRStandardAssets.Utils
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        public float clickLength = 1.2f;

        public float checkClick = 0f;
        ...
        private void Update()
        {
            ...
            if (checkClick >= clickLength)
            {
                Debug.Log("It has clicked");

                checkClick = 0f;
                // Change material/Scene Or something

                MeshRenderer sphereRenderer = reverseSphere.GetComponent<MeshRenderer>();

                // sphereRenderer.material = the new Material;
